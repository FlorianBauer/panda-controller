...
/// \date    2021-01-23
/// \brief   Definition of the RelativeMove Data Type for the RobotController Feature
...
struct RelativeMove {
    ...
    [[nodiscard]] sila2::de::fau::robot::robotcontroller::v1::DataType_RelativeMove::RelativeMove_Struct*
    makeNestedMessage() const {
        using sila2::de::fau::robot::robotcontroller::v1::DataType_RelativeMove;
        auto Result =
     ...
     */
    [[nodiscard]] sila2::de::fau::robot::robotcontroller::v1::DataType_RelativeMove
