...
public:
     ...
     * It contains the following Parameters:
     * @li OriginSite Site to move the plate from.
     * @li DestinationSite Site to move the plate to.
     ...
     * It contains the following Parameters:
     * @li Site Site to pick plate from.
     * @li PlateType The plate type to grab.
     *
     ...
     * It contains the following Parameters:
     * @li Site Site to place the plate on.
     * @li PlateType The plate type to grab.
     *
