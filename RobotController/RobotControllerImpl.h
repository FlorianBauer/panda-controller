...
public:
     ...
     *
     * @details Move in the given direction without changeing the current orientation of the
     * robot hand.
     *
     ...
     *
     * @details Sets the distance of the two finger to the given width. This operation can be
