...
public:
    ...
    : SiLA2::CSiLAServer{ServerInfo, Address}
    {
        ...
        registerFeature(siteManagerPtr.get(),
                SiLA2::CFeatureID{SiteManager::service_full_name()},
        CSiteManagerImpl::featureDefinition());
        registerFeature(robotControllePtr.get(),
                SiLA2::CFeatureID{RobotController::service_full_name()},
